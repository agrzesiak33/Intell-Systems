...
class Scroggle(object):
    ...
    def __init__(self):
        ...
        self.calculatedConstants4x4 = {0: [0.0, 0.0, 0.0], 1: [-4.99, -300.0, -290.0], 2: [-6.22, -172.5, -110.0],
                                       3: [-7.44, -330.0, -447.5], 4: [-6.68, -372.5, -255.0], 5: [-6.29, -577.5, -320.0],
                                       6: [-5.89, -535.0, -437.5], 7: [-4.31, -252.5, -337.5], 8: [-4.31, -450.0, -272.5],
                                       9: [-3.89, -412.5, -235.0], 10: [-4.44, -440.0, -450.0], 11: [-4.17, -430.0, -252.5],
                                       12: [-3.44, -382.5, -472.5], 13: [-2.89, -282.5, -490.0], 14: [-2.65, -412.5, -380.0],
                                       15: [-3.03, -387.5, -347.5], 16: [-3.07, -467.5, -437.5], 17: [-3.27, -270.0, -625.0],
                                       18: [-2.68, -482.5, -465.0], 19: [-3.11, -415.0, -535.0], 20: [-2.6, -387.5, -617.5],
                                       21: [-2.47, -535.0, -627.5], 22: [-2.11, -582.5, -662.5], 23: [-2.13, -595.0, -722.5],
                                       24: [-2.12, -607.5, -610.0], 25: [-2.08, -577.5, -767.5], 26: [-2.63, -477.5, -687.5],
                                       27: [-2.64, -615.0, -597.5], 28: [-2.7, -625.0, -695.0], 29: [-3.16, -492.5, -755.0],
                                       30: [-2.59, -532.5, -885.0], 31: [-2.71, -642.5, -812.5], 32: [-2.97, -562.5, -775.0],
                                       33: [-3.21, -697.5, -807.5], 34: [-2.64, -602.5, -640.0], 35: [-2.25, -492.5, -760.0],
                                       36: [-2.59, -525.0, -837.5], 37: [-2.43, -465.0, -812.5], 38: [-2.58, -592.5, -822.5],
                                       39: [-2.93, -587.5, -962.5], 40: [-3.23, -645.0, -867.5], 41: [-3.57, -745.0, -892.5],
                                       42: [-3.27, -777.5, -902.5], 43: [-4.07, -805.0, -847.5], 44: [-4.03, -772.5, -867.5],
                                       45: [-3.54, -860.0, -847.5], 46: [-3.54, -795.0, -850.0], 47: [-4.0, -812.5, -860.0],
                                       48: [-3.98, -840.0, -892.5], 49: [-3.92, -885.0, -875.0], 50: [-3.85, -785.0, -812.5],
                                       51: [-4.55, -822.5, -835.0], 52: [-4.56, -835.0, -942.5], 53: [-4.89, -817.5, -940.0],
                                       54: [-4.68, -762.5, -960.0], 55: [-4.78, -885.0, -1057.5], 56: [-4.77, -895.0, -1020.0],
                                       57: [-5.15, -907.5, -1102.5], 58: [-4.99, -877.5, -1055.0], 59: [-5.08, -945.0, -990.0]}
